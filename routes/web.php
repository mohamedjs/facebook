...
Route::post('addpost','postcontroller@store')->middleware('auth');
Route::get('addpost','postcontroller@store')->middleware('auth');
Route::post('/addcoment','commentcontroller@addcoment')->middleware('auth');
Route::get('/addcoment','commentcontroller@addcoment')->middleware('auth');
Route::post('/addlike','likecontroller@addlike')->middleware('auth');
Route::post('/unlike','likecontroller@unlike')->middleware('auth');
Route::get('/addlike','likecontroller@addlike')->middleware('auth');
Route::post('/deleteComment','commentcontroller@deleteComment')->middleware('auth');
Route::get('/deleteComment','commentcontroller@deleteComment')->middleware('auth');
Route::post('/updataComment','commentcontroller@updataComment')->middleware('auth');
Route::get('/updataComment','commentcontroller@updataComment')->middleware('auth');
...
Route::post('insertmessage','chatController@insert')->middleware('auth');
