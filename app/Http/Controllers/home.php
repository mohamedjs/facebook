...
class home extends Controller
{
  ...
  public function profile($id)
  {
    ...
    $freind1 = Auth::user()->recives()->wherePivot('check',1)->get();
    $freind2 = Auth::user()->sends()->wherePivot('check',1)->get();
    $prfreind1=$pruser->recives()->wherePivot('check',1)->get();
    $prfreind2=$pruser->sends()->wherePivot('check',1)->get();
    $myarray=array();
        foreach ($freind_request as $con) {
          array_push($myarray, $con->id);
        }
    ...
    return view('home.profile',compact('posts','user','freind_request','add_freind','freind1','freind2','users','pruser','prfreind1','prfreind2'));
  }
  ...
  public function myfreind()
  {
    ...
    $users = DB::table('users')->whereNotIn('id', $myarray)->get();
    return view('home.allfreind',compact('user','freind_request','add_freind','freind1','freind2','users','name'));
  }
  public function about()
  {
    ...
    $users = DB::table('users')->whereNotIn('id', $myarray)->get();
    return view('home.about',compact('user','freind_request','add_freind','freind1','freind2','users','name'));
  }
